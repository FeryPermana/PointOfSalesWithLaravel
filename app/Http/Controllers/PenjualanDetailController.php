...
class PenjualanDetailController extends Controller
{
    public function index()
    {
        ...
        if($id_penjualan = session('id_penjualan'))
        {
            ...
            $memberSelected = Penjualan::find($id_penjualan)->member ?? New Member();
    ...
    public function data($id)
    {
        ...
        foreach($detail as $item) {
            ...
            $row['jumlah']      = '<input type="number" class="form-control input-sm quantity" id="quantity" data-id="'. $item->id_penjualan_detail .'" value="'.$item->jumlah .'">';
